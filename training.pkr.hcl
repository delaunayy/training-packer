...
variable "ami_name" {
  type    = string
  default = "yde-debian-apache-{{timestamp}}"
}

source "amazon-ebs" "debian-yde" {
  ...
  ami_description = "YDE Debian AMI with Apache HTTP Server"
...
build {
  sources = ["source.amazon-ebs.debian-yde"]
